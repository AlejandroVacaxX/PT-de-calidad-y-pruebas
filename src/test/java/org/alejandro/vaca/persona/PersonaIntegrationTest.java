...
public class PersonaIntegrationTest {
        ...
        @Test
        @DisplayName("Elimina una persona localizándola por su RFC")
        ...
        @RepeatedTest(3)
        @DisplayName("Integración: Generación repetida de CURP")
        ...
        @Test
        @DisplayName("Integración: Error de validación Jakarta (Teléfono inválido)")
        ...
        @Test
        @DisplayName("Integración: Actualizar persona por RFC")
        ...
        @Test
        @DisplayName("Integración: Error de validación en Género (No permitido)")
        ...
        @Test
        @DisplayName("Integración: Error al registrar menor de 16 años (Regla RFC Punto V)")
        ...
        @DisplayName("Integración: Validación parametrizada de generación de RFC")
        ...
        void validacionRegexCurpAleatoriaTest() throws Exception {
                ...
                mockMvc.perform(org.springframework.test.web.servlet.request.MockMvcRequestBuilders.post(BASE_URL)
                                ...
                                .andExpect(status().isOk())
                                .andExpect(
                                                jsonPath("$.curp").value(org.hamcrest.Matchers
                                                                .matchesPattern("^[A-Z]{4}\\d{6}[A-Z0-9]{6}$")));
        }
<<<<<<< Updated upstream
=======
    }
    ...
    void getPersonasPorNombreTest() throws Exception {
        ...
        mockMvc.perform(get(BASE_URL + "{nombre}", nombre)
                .param("nombre", nombre)
                .param("apellidoP", apellidoP)
                .param("apellidoM", apellidoM))
                .andExpect(status().isOk())
    ...
    @Test
    @DisplayName("Actualiza una persona localizandola por su CURP")
    void actualizarPersonaPorCurpTest() throws Exception {
        String curp = "PIVE020712HDFRRR01";
        String idInterno = "id-doc-456";
        String jsonUpdate = """
    ...
    @Test
    @DisplayName("Actualiza una persona localizasndola por su RFC")
    void actualizarPersonaPorRfcTest() throws Exception {
        String rfc = "PIVE0120712";
        String idInterno = "id-doc-rfc-789";
        String jsonUpdate = """
    ...
    @RepeatedTest(10)
    @DisplayName("Integracion: Generacion repetida de CURP")
    void registroRepetidoCurpTest() throws Exception {
        String personaJson = """
                {
                    "nombre": "Edgar",
    ...
    @Test
    @DisplayName("Integracion: Error de validacion Jakarta (Telefono invalido)")
    void registroFallaTelefonoTest() throws Exception {
        String personaInvalida = """
                {
                    "nombre": "Error",
    ...
    @Test
    @DisplayName("Integracion: Error de validacion en Genero (no permitido)")
    void registroFallaGeneroTest() throws Exception {
        String personaInvalida = """
                {
                    "nombre": "Prueba",
    ...
    @DisplayName("Integración: Validación parametrizada de generacion de RFC")
    void registroRfcParametrizadoTest(String nom, String pat, String mat, String fecha, String rfcEsperado)
            throws Exception {
        String personaJson = String.format("""
                {
