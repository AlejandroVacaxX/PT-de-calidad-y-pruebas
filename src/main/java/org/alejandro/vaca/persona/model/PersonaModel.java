...
public record PersonaModel(
        ...
        @Min(value = 0, message = "La estatura no puede ser negativa") @Max(value = 3, message = "La estatura no puede ser mayor a 3 metros") @Pattern(regexp = "^([0-3](\\.[0-9]+)?)$", message = "La estatura debe ser un número entre 0 y 3 y no puede contener letras") Double estatura,
        @Min(value = 0, message = "El peso no puede ser negativo") @Max(value = 280, message = "El peso no puede sobrepasar los 280kg") @Pattern(regexp = "^([0-280](\\.[0-9]+)?)$", message = "El peso no puede ser mayor a 280 kg") Double peso,
